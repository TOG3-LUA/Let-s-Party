...
-- Scripts:
print("Thanks for using TOG3 Modified script! Feel free to share this script, and if you find any bugs (there are a lot of them which im lazy to fix) add me on discord: gergerpukpuk123")
